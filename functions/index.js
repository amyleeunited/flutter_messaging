...
//exports.doSomething = function(){console.log("doSomething");}
...
exports.addMessageFS = functions.https.onRequest(async (req, res) => {
...
exports.makeUppercaseFS = functions.firestore.document('/messages/{documentId}')
